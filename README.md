<div align="center">
  ...
  <p>
    <a href="https://byteaegis.online">byteaegis.online</a>
  </p>
</div>

<br />

**byteaegis** is a service-based cybersecurity and software development startup founded by Mohamed Adhnaan J M. We work with startups, small businesses, and development teams who need security-focused software built for them or who need their existing systems secured and hardened.
...
We utilize a modern, production-hardened tech stack to deliver fast and secure applications:
- **Core**: Next.js, React, TypeScript, Node.js, Python, Rust, FastAPI
- **Security & CI/CD**: Docker, Kubernetes, Semgrep, Snyk, GitHub Actions, Terraform
- **UI/UX**: Tailwind CSS, Framer Motion, MagicUI
...
# Run the development server with Turbopack for instant HMR
npm run dev
```
