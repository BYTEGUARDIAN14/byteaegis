  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 sm:px-6 text-center">
        ...
        >
          byteaegis builds security-focused software for startups, small businesses,
          and engineering teams. Security is not an afterthought here.
          It is fundamental to every engagement we take on.
        </motion.p>
        ...
        >
          ...
          <Link href="/contact">
            <button
              className="flex items-center gap-3 px-7 py-3.5 font-bold text-sm transition-all duration-100"
              style={{
                fontFamily: "'Space Grotesk', sans-serif",
