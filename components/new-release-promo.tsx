...
export function NewReleasePromo() {
  return (
    <section className="mt-12 w-full" style={{ backgroundColor: "#1E1D1B" }}>
      <div
        className="mx-auto max-w-4xl p-[3px]"
        style={{ border: "2px solid #C9FF3F", boxShadow: "8px 8px 0px 0px #C9FF3F" }}
      >
        <div
          className="relative mx-auto h-[400px] max-w-4xl overflow-hidden p-2"
          style={{ backgroundColor: "#C9FF3F", position: "relative" }}
        >
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2
                ...
                style={{ fontFamily: "'Space Grotesk', sans-serif", color: "#1E1D1B", letterSpacing: "-0.035em" }}
              >
                Build. Secure. Ship.
              </h2>
              <p className="mb-8" style={{ fontFamily: "'IBM Plex Sans', sans-serif", color: "rgba(30,29,27,0.65)" }}>
              ...
              <div className="flex items-center justify-center">
                <Link href="/contact">
                  <button
                    className="flex items-center gap-3 px-6 py-3 font-bold text-base mt-6 transition-all duration-100"
                    style={{
                    ...
                    onMouseEnter={e => {
                      ...
                      el.style.boxShadow = "6px 6px 0px 0px rgba(0,0,0,0.35)"
                    }}
                    onMouseLeave={e => {
                      const el = e.currentTarget as HTMLElement
                      el.style.transform = "translate(0,0)"
                      el.style.boxShadow = "4px 4px 0px 0px rgba(0,0,0,0.35)"
                    }}
                  >
            ...
            {/* Stroked wordmark */}
            <h1
              className="absolute inset-x-0 mt-[120px] text-center text-[100px] font-semibold sm:mt-[30px] sm:text-[190px] pointer-events-none"
              style={{ WebkitTextStroke: "1px #1E1D1B", color: "transparent" }}
              aria-hidden="true"
            >
              byteaegis
            </h1>
            <h1
              className="absolute inset-x-0 mt-[120px] text-center text-[100px] font-semibold sm:mt-[30px] sm:text-[190px] pointer-events-none opacity-[0.07]"
              style={{ color: "#1E1D1B" }}
              aria-hidden="true"
            >
              byteaegis
